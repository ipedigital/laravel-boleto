...
class Santander356 extends AbstractRemessa implements RemessaContract
{
    ...
    protected function header()
    {
        ...
        $this->add(27, 27, '0');
        $this->add(28, 39, Util::formatCnab('9', $this->getCodigoTransmissao(), 20));
        $this->add(40, 46, '');
    ...
    public function addBoleto(BoletoContract $boleto, $dadosPartilha = [])
    {
        ...
        $this->add(31, 38, '');
        $this->add(39, 62, Util::formatCnab('X', $boleto->getNumeroControle(), 25)); // numero de controle
        $this->add(63, 64, '00');
        $this->add(65, 71, Util::formatCnab('9', $nossoNumero,7));
        $this->add(72, 72, '0');
        $this->add(73, 74, '00');
        $this->add(75, 75, '1');
        $this->add(79, 88, Util::formatCnab('9', $boleto->getMulta(), 13, 2));
        $this->add(89, 95, '');
