...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        $this->add(58, 58, Util::formatCnab('9', '5', 1)); // Tipo de Cobrança
    ...
    public function segmentoQ(BoletoContract $boleto)
    {
        ...
        $this->add(154, 154, strlen(Util::onlyNumbers($this->getPagador()->getDocumento())) == 14 ? '2' : '1');
    ...
    {
        return Util::formatCnab('9', $this->getAgencia(), 4) . Util::formatCnab('9', $this->getCodigoCliente(), 11);
    }
